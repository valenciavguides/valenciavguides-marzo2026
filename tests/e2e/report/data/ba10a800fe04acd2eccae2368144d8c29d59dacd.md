...
- Name: 06-race-conditions.spec.js >> Race conditions documentadas — DT-1 Opción B >> Race #1c. llamar isMapInitialized() dos veces devuelve el mismo valor (idempotente)
- Location: tests\e2e\06-race-conditions.spec.js:98:3
