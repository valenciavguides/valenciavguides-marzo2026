...
- Name: 01-fase1-boot.spec.js >> FASE 1 — Secuencia de arranque del padre >> 1a. globalThis.__vv_stateManager es un objeto con las APIs esperadas
- Location: tests\e2e\01-fase1-boot.spec.js:57:3
