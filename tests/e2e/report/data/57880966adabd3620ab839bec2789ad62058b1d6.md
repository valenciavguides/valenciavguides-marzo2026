...
- Name: 09-mode-change.spec.js >> Protocolo de cambio de modo — escenario 1e >> MC-4. CAMBIO_MODO está en __CONTROLADOR_REGISTRADOS tras FASE 1
- Location: tests\e2e\09-mode-change.spec.js:133:3
