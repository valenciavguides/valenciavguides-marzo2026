...
- Name: 09-mode-change.spec.js >> Protocolo de cambio de modo — escenario 1e >> MC-2. actualizarInterfazModo es una función (expuesta en window por app.js)
- Location: tests\e2e\09-mode-change.spec.js:66:3
