...
- Name: 01-fase1-boot.spec.js >> FASE 1 — Secuencia de arranque del padre >> procesarControladoresPendientes existe y es una función tras el arranque
- Location: tests\e2e\01-fase1-boot.spec.js:97:3
