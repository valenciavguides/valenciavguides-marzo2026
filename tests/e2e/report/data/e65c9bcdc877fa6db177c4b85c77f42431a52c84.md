...
- Name: 09-mode-change.spec.js >> Protocolo de cambio de modo — escenario 1e >> MC-1a. globalThis.manejarCambioModo existe como función (expuesta por app.js)
- Location: tests\e2e\09-mode-change.spec.js:47:3
...
```ts
  1   | /**
  2   |  * 09-mode-change.spec.js
  3   |  *
  4   |  * Prerequisito DT-1 Opción B — escenario 1e:
  5   |  *   "El test debe disparar un cambio de modo y confirmar que los 4 mensajes
  6   |  *   se producen con el hijo correcto, que globalThis.estadoPadre.modo.actual cambia,
  7   |  *   y que el Map _respuestasEntendidoActual se limpia al inicio de cada ciclo."
  8   |  *
