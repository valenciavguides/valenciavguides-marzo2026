...
function combinarDatosParada(item) {
    ...
    if (global.globalThis.__vv_DATOS_AVENTURAS && global.globalThis.aventuraSeleccionada) {
        const datosAventura = global.globalThis.__vv_DATOS_AVENTURAS[global.globalThis.aventuraSeleccionada];
    ...
    if (global.globalThis.__vv_AUDIOS_AVENTURAS && global.globalThis.aventuraSeleccionada && global.globalThis.idiomaSeleccionado) {
        const audiosAventura = global.globalThis.__vv_AUDIOS_AVENTURAS[global.globalThis.aventuraSeleccionada];
        if (audiosAventura && audiosAventura[global.globalThis.idiomaSeleccionado]) {
            const audioEncontrado = audiosAventura[global.globalThis.idiomaSeleccionado].find(a =>
    ...
    if (global.globalThis.__vv_RETOS_AVENTURAS && global.globalThis.aventuraSeleccionada && global.globalThis.idiomaSeleccionado) {
        const retosAventura = global.globalThis.__vv_RETOS_AVENTURAS[global.globalThis.aventuraSeleccionada];
        if (retosAventura && retosAventura[global.globalThis.idiomaSeleccionado]) {
            const retoEncontrado = retosAventura[global.globalThis.idiomaSeleccionado].find(r =>
                r.id === item.reto_id
            );
            if (retoEncontrado) {
...
try {
    ...
    const paradasNormalizadas = normalizarParadas(global.globalThis.AVENTURA_PARADAS);
    ...
    const respuesta = {
        ...
        datos: {
            ...
            total: global.globalThis.AVENTURA_PARADAS.length,
            estadisticas: {
                paradas: global.globalThis.AVENTURA_PARADAS.filter(p => p.tipo === 'parada').length,
                tramos: global.globalThis.AVENTURA_PARADAS.filter(p => p.tipo === 'tramo').length
            },
            metadatos: {
                timestamp: Date.now(),
                version: 'combinada_v1',
                aventura: global.globalThis.aventuraSeleccionada,
                idioma: global.globalThis.idiomaSeleccionado
            }
        }
    };
