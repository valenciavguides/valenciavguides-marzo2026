    ...
    showToast(error, options = {}) {
        ...
        toastEl.innerHTML = `
            ...
            <div class="error-toast-content">
                <div class="error-toast-title">${this._escapeHtml(title || ERROR_TITLES[codigo] || 'Error')}</div>
    ...
    showModal(error, options = {}) {
        ...
        overlay.innerHTML = `
            <div class="error-modal">
                ...
                <div class="error-modal-title">${this._escapeHtml(title || ERROR_TITLES[codigo] || 'Ha ocurrido un error')}</div>
