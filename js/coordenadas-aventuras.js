 ...
 * }
 *
 * POR QUÉ .parada = N + 3 (y el id no):
 * Antes de la parada 0 de cada aventura existen 3 elementos que el usuario
 * recorre igualmente pero que no tienen coordenadas y por eso no viven en este
 * archivo: pre-intro1, pre-intro2 e intro (definidos en aventuras-ID-padre.js,
 * con reto_id "PZ-intro", "R1-AvX" y "R2-AvX"). El primer reto real de la
 * parada 0 es, en consecuencia, el reto 3 (ver retos-aventuras.js) — ese mismo
 * +3 se traslada aquí al campo .parada, que numera la posición global de la
 * parada dentro de la aventura completa (intro incluida).
 * El id ('AvX-P-N') y el comentario "// Parada N:" que precede a cada bloque
 * NO llevan ese +3: ambos numeran solo la posición dentro de este archivo
 * (0-indexada), por eso id y comentario coinciden entre sí pero no con .parada.
 *
 * ── TRAMO ─────────────────────────────────────────────────────────────────────
...
// coordenadas completas hijo2 Aventura1 //
    ...
    // Parada 2: calle Muro Santa Ana (Reto 5) (Párrafos: 68)
    {
        id: "Av1-P-2",
        tipo: "parada",
        parada: 5, // sin número en el mapa
        mapa_numero: null,
    ...
    // Parada 3: Iglesia de San Lorenzo (Reto 6) (Párrafos: 682-B, 462, 684, 683)
    {
        id: "Av1-P-3",
        tipo: "parada",
        parada: 6, // sin número en el mapa (Iglesia de San Lorenzo)
        mapa_numero: null,
    ...
    // Parada 10: Arco Novo Catedral y Puerta Negra Basílica (Párrafos: 446, 355, 447, 11-B, 451, 452)
    {
        id: "Av1-P-10",
        tipo: "parada",
        parada: 13, // mapa número 5 y mapa número 9
        mapa_numero: "5,9",
    ...
    // Parada 11: Casa del Punt de Gantxo (Reto 13) (Párrafos: 51-C, 454, 455, 455-B, 148, 456)
    {
        id: "Av1-P-11",
        tipo: "parada",
        parada: 14, // sin número en el mapa (Casa del Punt de Gantxo)
        mapa_numero: null,
    ...
    // Parada 24: Edificio Suay - La Equitativa (Reto 23) (Párrafos: 693, 693-B)
    {
        id: "Av1-P-24",
        tipo: "parada",
        parada: 27, // sin número en el mapa (Edificio Suay - La Equitativa)
        mapa_numero: null,
    ...
    // Parada 35: Lonja (Mercado de la Seda) Fornicador (Reto 33) (Párrafos: 386, 387)
    {
        id: "Av1-P-35",
        tipo: "parada",
  ...
  Aventura2: {
    ...
    // ────---------------------------------------------
                ...
                // Tramo 3 - Palau de la Generalitat → Calle Caballeros (Párrafos: 104, 484, 485-B, 486)
                {
                    id: "Av2-TR-3",
                    tipo: "tramo",
                ...
                // Parada 6 - Iglesia de San Nicolás BACK (Reto 7) (Párrafos: 493, 494-B, 495, 496)
                {
                    id: "Av2-P-6",
                    tipo: "parada",
  ...
  Aventura3: {
    ...
    // Tramo 29: Plaza de la Virgen → Torres de Serranos (Párrafos: 433, 2-F) (pausa muy larga con música de al menos 2min 30seg)
    {
        id: "Av3-TR-29",
        tipo: "tramo",
  ...
  Aventura4: {
    ...
    // Parada 29: Museo de Ciencias Naturales (Reto 19) (Párrafos: viv6, viv5)
    {
        id: "Av4-P-29",
        tipo: "parada",
        parada: 32, // mapa número v8
        mapa_numero: "v8",
        nombre: "Museo de Ciencias Naturales",
        coordenadas: { lat: Number('39.479455'), lng: Number('-0.368610') },
        imagen: "imagenes/imagenes-aventuras/viveros_museo_ciencias_naturales.jpg",
    },
    // Tramo 24: Museo de Ciencias Naturales → Jardín de la Rosaleda (Párrafos: viv7, viv8)
    {
        id: "Av4-TR-24",
        tipo: "tramo",
    ...
    // Parada 32: Estanque de los patos (Reto 20) (Párrafos: viv11-C, viv12)
    {
        id: "Av4-P-32",
        tipo: "parada",
  ...
  Aventura5: {
    ...
    // Parada 13: Mercado de Colón Back (Reto: 13) (Párrafos: 315, 316)
    {
        id: "Av5-P-13",
        tipo: "parada",
    ...
    // Parada 34: Iglesia de la Milagrosa (Reto 28) (Párrafos: 568, 127, 569)
    {
        id: "Av5-P-34",
        tipo: "parada",
...
// coordenadas completas hijo2 Aventura Fallas //
    ...
    // Tramo 1: Torres de Serranos → Plaza de la Crída (Torres de Serranos Front)(Párrafos: 229, 129, 593, 129-B, 471, 5, 607, 626, 629, 697, 698, 118, 130, 666, 696, 131, 132, 133, 134, 135)
    {
        id: "AvFallas-TR-1",
        tipo: "tramo",
  ...
  Aventura34km: {
        ...
        // poner las coordenadas específicas de los puntos a visitar del mapa. mapa-completo.html ignora automáticamente las que tengan coordenadas: null.
    {
        ...
        id: "REF-1",
        mapa_numero: 1,
        coordenadas: { lat: Number('39.47921'), lng: Number('-0.37604') },
        nombre: "Torres de Serranos",
        imagen: "imagenes/imagenes-aventuras/00_ torres_de serranos_back.jpg",
    },
    {
        ...
        id: "REF-2",
        mapa_numero: 2,
        coordenadas: { lat: Number('39.47977'), lng: Number('-0.37578') },
        nombre: "Puente de Serranos (Plaza de la Crída)",
        imagen: "imagenes/imagenes-aventuras/torres_de_serranos_front.jpg",
    },
    {
    ...
    },
    {
        ...
        id: "REF-4",
        mapa_numero: 4,
        coordenadas: { lat: Number('39.4732'), lng: Number('-0.36583') },
        nombre: "Puente de la Exposición",
        imagen: "imagenes/imagenes-aventuras/pont_de_la_exposicio.jpg",
    },
    {
        ...
        id: "REF-5",
        mapa_numero: 5,
        coordenadas: { lat: Number('39.4711'), lng: Number('-0.36424') },
        nombre: "Puente de las Flores",
        imagen: "imagenes/imagenes-aventuras/puente_flores-down.jpg",
    },
    {
        ...
        id: "REF-6",
        mapa_numero: 6,
        coordenadas: { lat: Number('39.47026'), lng: Number('-0.3637') },
        nombre: "Puente del Mar",
        imagen: "imagenes/imagenes-aventuras/pont_de_la_mar.jpg",
    },
    {
        tipo: "referencia",
        id: "REF-7",
        mapa_numero: 7,
        coordenadas: { lat: Number('39.46888'), lng: Number('-0.3628') },
        nombre: "Puente de Aragón",
        imagen: "imagenes/imagenes-aventuras/puente_aragon-down.jpg",
    },
    {
        ...
        id: "REF-8",
        mapa_numero: 8,
        coordenadas: { lat: Number('39.46616'), lng: Number('-0.36042') },
        nombre: "Palacio de la Música",
        imagen: "imagenes/imagenes-aventuras/palau_de_la_musica.jpg",
    },
    {
    ...
    },
    {
        ...
        id: "REF-10",
        mapa_numero: 10,
        coordenadas: { lat: Number('39.46256'), lng: Number('-0.35941') },
        nombre: "Gulliver",
        imagen: "imagenes/imagenes-aventuras/gulliver_maqueta.jpg",
    },
    {
        ...
        id: "REF-11",
        mapa_numero: 11,
        coordenadas: { lat: Number('39.45998'), lng: Number('-0.3575') },
        nombre: "Pistas de Patinaje",
        imagen: "imagenes/imagenes-aventuras/CAC_patinaje.jpg",
    },
    {
        ...
        id: "REF-12",
        mapa_numero: 12,
        coordenadas: { lat: Number('39.45805'), lng: Number('-0.35594') },
        nombre: "Opera Reina Sofía",
        imagen: "imagenes/imagenes-aventuras/reina_sofia_side.jpg",
    },
    {
    ...
    },
    {
        ...
        id: "REF-14",
        mapa_numero: 14,
        coordenadas: { lat: Number('39.4561'), lng: Number('-0.35209') },
        nombre: "Mueseo de las Ciencias Príncipe Felipe",
        imagen: "imagenes/imagenes-aventuras/museo_principe_felipe.jpg",
    },
    {
        ...
        id: "REF-15",
        mapa_numero: 15,
        coordenadas: { lat: Number('39.45472'), lng: Number('-0.34981') },
        nombre: "Puente l'Assut de l'Or",
        imagen: "imagenes/imagenes-aventuras/puente_assut.jpg",
    },
    {
        ...
        id: "REF-16",
        mapa_numero: 16,
        coordenadas: { lat: Number('39.45388'), lng: Number('-0.3498') },
        nombre: "Ágora",
        imagen: "imagenes/imagenes-aventuras/agora.jpg",
    },
    {
        ...
        id: "REF-17",
        mapa_numero: 17,
        coordenadas: { lat: Number('39.45282'), lng: Number('-0.34812') },
        nombre: "Oceanogràfic",
        imagen: "imagenes/imagenes-aventuras/oceanografic.jpg",
    },
    {
        ...
        id: "REF-18",
        mapa_numero: 18,
        coordenadas: { lat: Number('39.45496'), lng: Number('-0.35318') },
        nombre: "Umbracle",
        imagen: "imagenes/imagenes-aventuras/umbracle.jpg",
    },
    {
        ...
        id: "REF-19",
        mapa_numero: 19,
        coordenadas: { lat: Number('39.45664'), lng: Number('-0.35386') },
        nombre: "Hemisfèric",
        imagen: "imagenes/imagenes-aventuras/hemisferic.jpg",
    },
    {
        ...
        imagen: "imagenes/imagenes-aventuras/puente_flores_agua.jpg",
    },
    {
        tipo: "referencia",
        id: "REF-21",
        mapa_numero: 21,
        coordenadas: { lat: Number('39.47211'), lng: Number('-0.36848') },
        nombre: "Puerta del Mar",
        imagen: "imagenes/imagenes-aventuras/puerta_del_mar.jpg",
    },
    {
        tipo: "referencia",
        id: "REF-22",
    ...
    },
    {
        ...
        id: "REF-25",
        mapa_numero: 25,
        coordenadas: { lat: Number('39.46666'), lng: Number('-0.37614') },
        nombre: "Plaza de Toros 🐂",
        imagen: "imagenes/imagenes-aventuras/Plaza_Toros.jpg",
    },
    {
        ...
        id: "REF-26",
        mapa_numero: 26,
        coordenadas: { lat: Number('39.46708'), lng: Number('-0.37719') },
        nombre: "Estación del Norte 🚂",
        imagen: "imagenes/imagenes-aventuras/Estacion_Norte.jpg",
    },
    {
        ...
        id: "REF-27",
        mapa_numero: 27,
        coordenadas: { lat: Number('39.47062'), lng: Number('-0.37684') },
        nombre: "Plaza del Ayuntamiento",
        imagen: "imagenes/imagenes-aventuras/plaza_del_ayuntamiento.jpg",
    },
    {
    ...
    },
    {
        ...
        id: "REF-29",
        mapa_numero: 29,
        coordenadas: { lat: Number('39.46945'), lng: Number('-0.37554') },
        nombre: "Palacio de Comunicaciones (Correos)",
        imagen: "imagenes/imagenes-aventuras/correos.jpg",
    },
    {
        ...
        id: "REF-30",
        mapa_numero: 30,
        coordenadas: { lat: Number('39.4707'), lng: Number('-0.37391') },
        nombre: "Banco Central de Valencia",
        imagen: "imagenes/imagenes-aventuras/banco_valencia.jpg",
    },
    {
        tipo: "referencia",
        id: "REF-31",
        mapa_numero: 31,
        coordenadas: { lat: Number('39.47272'), lng: Number('-0.37468') },
        nombre: "Palacio del Marqués de Dos Aguas (Museo Nacional de Cerámica)",
        imagen: "imagenes/imagenes-aventuras/Marques_dos_aguas_2.jpg",
    },
    {
        ...
        id: "REF-32",
        mapa_numero: 32,
        coordenadas: { lat: Number('39.4737'), lng: Number('-0.37868') },
        nombre: "Mercado Central",
        imagen: "imagenes/imagenes-aventuras/mercado_central.jpg",
    },
    {
        ...
        id: "REF-33",
        mapa_numero: 33,
        coordenadas: { lat: Number('39.47421'), lng: Number('-0.37919') },
        nombre: "Real Parroquia de los Santos Juanes (San Juan del Mercado)",
        imagen: "imagenes/imagenes-aventuras/santos_juanes.jpg",
    },
    {
        tipo: "referencia",
        id: "REF-34",
        mapa_numero: 34,
        coordenadas: { lat: Number('39.47438'), lng: Number('-0.37834') },
        nombre: "Lonja de la Seda",
        imagen: "imagenes/imagenes-aventuras/lonja_seda.jpg",
    },
    {
        tipo: "referencia",
        id: "REF-35",
        mapa_numero: 35,
        coordenadas: { lat: Number('39.47433'), lng: Number('-0.37778') },
        nombre: "Plaza del Doctor López Collado",
        imagen: "imagenes/imagenes-aventuras/plaza_doctor_lopez_collado.jpg",
    },
    {
        tipo: "referencia",
        id: "REF-36",
        mapa_numero: 36,
        coordenadas: { lat: Number('39.47367'), lng: Number('-0.37657') },
        nombre: "Plaza Redonda",
        imagen: "imagenes/imagenes-aventuras/plaza_redonda.jpg",
    },
    {
        ...
        id: "REF-37",
        mapa_numero: 37,
        coordenadas: { lat: Number('39.47404'), lng: Number('-0.37675') },
        nombre: "Plaza Lope de Vega - Edificio estrecho",
        imagen: "imagenes/imagenes-aventuras/edificio_estrecho.jpg",
    },
    {
        ...
        id: "REF-38",
        mapa_numero: 38,
        coordenadas: { lat: Number('39.47397'), lng: Number('-0.37622') },
        nombre: "Torre de Santa Catalina",
        imagen: "imagenes/imagenes-aventuras/torre_santa_catalina.jpg",
    },
    {
        ...
        id: "REF-39",
        mapa_numero: 39,
        coordenadas: { lat: Number('39.47533'), lng: Number('-0.37563') },
        nombre: "Catedral de Valencia (Torre del Miguelete)",
        imagen: "imagenes/imagenes-aventuras/puerta_barroca_catedral_miguelete.jpg",
    },
    {
        ...
        id: "REF-40",
        mapa_numero: 40,
        coordenadas: { lat: Number('39.47576'), lng: Number('-0.37486') },
        nombre: "Catedral de Valencia",
        imagen: "imagenes/imagenes-aventuras/catedral_almoina.jpg",
    },
    {
        ...
        id: "REF-41",
        mapa_numero: 41,
        coordenadas: { lat: Number('39.47626'), lng: Number('-0.37484') },
        nombre: "Real Basílica de Nuestra Señora de los Desamparados",
        imagen: "imagenes/imagenes-aventuras/basilica_desamparados.jpg",
    },
    {
        tipo: "referencia",
        id: "REF-42",
        mapa_numero: 42,
        coordenadas: { lat: Number('39.47626'), lng: Number('-0.37416') },
        nombre: "Museo Arqueológico de la Almoína",
        imagen: "imagenes/imagenes-aventuras/museo_almoina.jpg",
    },
    {
        tipo: "referencia",
        id: "REF-43",
        mapa_numero: 43,
        coordenadas: { lat: Number('39.47634'), lng: Number('-0.37531') },
        nombre: "Plaza de la Virgen",
        imagen: "imagenes/imagenes-aventuras/plaza_de_la_virgen.jpg",
    },
    {
        ...
        id: "REF-44",
        mapa_numero: 44,
        coordenadas: { lat: Number('39.4767'), lng: Number('-0.37665') },
        nombre: "Palacio de la Generalitat Valenciana",
        imagen: "imagenes/imagenes-aventuras/palau_de_la_generalitat.jpg",
    },
    {
        ...
        id: "REF-45",
        mapa_numero: 45,
        coordenadas: { lat: Number('39.47662'), lng: Number('-0.37713') },
        nombre: "Calle Caballeros",
        imagen: "imagenes/imagenes-aventuras/Calle_caballeros.jpg",
    },
    {
        ...
        id: "REF-46",
        mapa_numero: 46,
        coordenadas: { lat: Number('39.47655'), lng: Number('-0.37883') },
        nombre: "Parroquia de San Nicolás",
        imagen: "imagenes/imagenes-aventuras/iglesia_san_nicolas_front.jpg",
    },
    {
    ...
    },
    {
        ...
        id: "REF-48",
        mapa_numero: 48,
        coordenadas: { lat: Number('39.47608'), lng: Number('-0.37736') },
        nombre: "Plaza del Negrito",
        imagen: "imagenes/imagenes-aventuras/Plaza_negrito.jpg",
    },
    {
        ...
        id: "REF-49",
        mapa_numero: 49,
        coordenadas: { lat: Number('39.47628'), lng: Number('-0.3801') },
        nombre: "Plaza del Tossal",
        imagen: "imagenes/imagenes-aventuras/plaza_del_tossal.jpg",
    },
    {
        ...
        id: "REF-50",
        mapa_numero: 50,
        coordenadas: { lat: Number('39.47755'), lng: Number('-0.3786') },
        nombre: "Portal de la Valldigna",
        imagen: "imagenes/imagenes-aventuras/portal-de-la_valldigna.jpg",
    },
    {
        ...
        id: "REF-51",
        mapa_numero: 51,
        coordenadas: { lat: Number('39.47816'), lng: Number('-0.3777') },
        nombre: "Torre del Ángel (árabe)",
        imagen: "imagenes/imagenes-aventuras/torre_del_angel.jpg",
    },
    {
        tipo: "referencia",
        id: "REF-52",
        mapa_numero: 52,
        coordenadas: { lat: Number('39.47831'), lng: Number('-0.37654') },
        nombre: "Refugio de la Guerra Civil 1936-39",
        imagen: "imagenes/imagenes-aventuras/refugio_guerra_civil.jpg",
    },
    {
        ...
        id: "REF-53",
        mapa_numero: 53,
        coordenadas: { lat: Number('39.47905'), lng: Number('-0.37688') },
        nombre: "Museo Corpus Christi (Museo de las Rocas) 🛞",
        imagen: "imagenes/imagenes-aventuras/casa_rocas.jpg",
    },
    {
        ...
        id: "REF-54",
        mapa_numero: 54,
        coordenadas: { lat: Number('39.47926'), lng: Number('-0.37862') },
        nombre: "Parroquia de la Santísima Cruz (Carmen)",
        imagen: "imagenes/imagenes-aventuras/iglesia_del_carmen.jpg",
    },
    {
        ...
        id: "REF-55",
        mapa_numero: 55,
        coordenadas: { lat: Number('39.47937'), lng: Number('-0.37883') },
        nombre: "Centro Cultural Contemporáneo “El Carmen”",
        imagen: "imagenes/imagenes-aventuras/centro_cultural_el_carmen.jpg",
    },
    {
        ...
        id: "REF-56",
        mapa_numero: 56,
        coordenadas: { lat: Number('39.4797'), lng: Number('-0.37952') },
        nombre: "Casa de los Gatos 😼",
        imagen: "imagenes/imagenes-aventuras/casa_de_los_gatos.jpg",
    },
    {
    ...
    },
    {
        ...
        coordenadas: { lat: Number('39.478241'), lng: Number('-0.383093') },
        nombre: "Museo de Etnología de Valencia",
        imagen: "imagenes/imagenes-aventuras/museo_etnologia.jpg",
    },
    {
        tipo: "referencia",
        id: "REF-60",
    ...
    },
    {
        ...
        id: "REF-64",
        mapa_numero: 64,
        coordenadas: { lat: Number('39.476083'), lng: Number('-0.386579') },
    ...
    },
    {
        ...
        id: "REF-65",
        mapa_numero: 65,
        coordenadas: { lat: Number('39.477613'), lng: Number('-0.388283') },
    ...
    },
    {
        ...
        id: "REF-66",
        mapa_numero: 66,
        coordenadas: { lat: Number('39.4772'), lng: Number('-0.39314') },
        nombre: "Estadio de Atletismo",
        imagen: "imagenes/imagenes-aventuras/estadio_atletismo.jpg",
    },
    {
    ...
    },
    {
        ...
        id: "REF-68",
        mapa_numero: 68,
        coordenadas: { lat: Number('39.47533'), lng: Number('-0.3976') },
        nombre: "Na Turia",
        imagen: "imagenes/imagenes-aventuras/naturia_front.jpg",
    },
    {
        ...
        id: "REF-69",
        mapa_numero: 69,
        coordenadas: { lat: Number('39.47427'), lng: Number('-0.40275') },
        nombre: "Puente Amarillo (Casa del Agua)",
        imagen: "imagenes/imagenes-aventuras/puente_amarillo.jpg",
    },
    {
        ...
        id: "REF-70",
        mapa_numero: 70,
        coordenadas: { lat: Number('39.47391'), lng: Number('-0.4056') },
        nombre: "Puente 9 de Octubre",
    ...
    },
    {
        ...
        id: "REF-74",
        mapa_numero: 74,
        coordenadas: { lat: Number('39.47287'), lng: Number('-0.40827') },
        nombre: "Museo de Historia de Valencia",
        imagen: "imagenes/imagenes-aventuras/museo_de_historia.jpg",
    },
    {
        ...
        id: "REF-75",
        mapa_numero: 75,
        coordenadas: { lat: Number('39.482209'), lng: Number('-0.38032') },
        nombre: "Puente de San José",
        imagen: "imagenes/imagenes-aventuras/puente_san_jose.jpg",
    },
    {
        ...
        id: "REF-76",
        mapa_numero: 76,
        coordenadas: { lat: Number('39.47785'), lng: Number('-0.37129') },
        nombre: "Ruinas en el Jardín del Turia",
        imagen: "imagenes/imagenes-aventuras/ruinas_turia.jpg",
    },
    {
    ...
    },
    {
        ...
        id: "REF-78",
        mapa_numero: 78,
        coordenadas: { lat: Number('39.4765'), lng: Number('-0.36876') },
        nombre: "Puente del Real",
        imagen: "imagenes/imagenes-aventuras/puente_real.jpg",
    },
    {
        ...
        id: "REF-79",
        mapa_numero: 79,
        coordenadas: { lat: Number('39.472999'), lng: Number('-0.369576') },
    ...
    },
    {
        ...
        id: "REF-80",
        mapa_numero: 80,
        coordenadas: { lat: Number('39.47203'), lng: Number('-0.3696') },
        nombre: "Palacio de Justicia",
        imagen: "imagenes/imagenes-aventuras/palacio_justicia.jpg",
    },
    {
        ...
        id: "REF-81",
        mapa_numero: 81,
        coordenadas: { lat: Number('39.47343'), lng: Number('-0.37019') },
        nombre: "Fundación Bancaja",
        imagen: "imagenes/imagenes-aventuras/edificio_bancaja_2.jpg",
    },
    {
        ...
        id: "REF-82",
        mapa_numero: 82,
        coordenadas: { lat: Number('39.47412'), lng: Number('-0.37249') },
        nombre: "Parroquia de Santo Tomás Apostol y San Felipe Neri",
        imagen: "imagenes/imagenes-aventuras/santo_tomas_felipe_neri.jpg",
    },
    {
        tipo: "referencia",
        id: "REF-83",
        mapa_numero: 83,
        coordenadas: { lat: Number('39.47438'), lng: Number('-0.37282') },
        nombre: "Iglesia de San Juan del Hospital",
        imagen: "imagenes/imagenes-aventuras/san_juan_hospital.jpg",
    },
    {
        tipo: "referencia",
        id: "REF-84",
        mapa_numero: 84,
        coordenadas: { lat: Number('39.47537'), lng: Number('-0.37431') },
        nombre: "Palacio Arzobispal",
        imagen: "imagenes/imagenes-aventuras/palacio_arzobispal.jpg",
    },
    {
        ...
        id: "REF-85",
        mapa_numero: 85,
        coordenadas: { lat: Number('39.47593'), lng: Number('-0.373852') },
    ...
    },
    {
        ...
        id: "REF-86",
        mapa_numero: 86,
        coordenadas: { lat: Number('39.475814'), lng: Number('-0.374132') },
        nombre: "Cripta de San Vicente Mártir",
        imagen: "",
    },
    {
        tipo: "referencia",
        id: "REF-87",
        mapa_numero: 87,
        coordenadas: { lat: Number('39.476579'), lng: Number('-0.373912') },
        nombre: "Almudín",
        imagen: "",
    },
    {
        ...
        id: "REF-88",
        mapa_numero: 88,
        coordenadas: { lat: Number('39.47782'), lng: Number('-0.37487') },
        nombre: "Iglesia de San Lorenzo",
        imagen: "imagenes/imagenes-aventuras/iglesia_san_lorenzo.jpg",
    },
    {
    ...
    // Tramo 11: Mirador de la Ciudad de las Artes y de las Ciencias: Opera Reina Sofía y Museo Principe Felipe → Puente l'Assut de l'Or (Párrafos: 276, 22)
    {
        id: "Av34km-TR-11",
        tipo: "tramo",
    ...
    // Tramo 24: Estación del Norte (interior) → Plaza del Ayuntamiento (Párrafos: 331)
    {
        ...
        [
            ...
            { lat: Number('39.467611'), lng: Number('-0.377288') },
            { lat: Number('39.467989'), lng: Number('-0.377120') },
            { lat: Number('39.468307'), lng: Number('-0.377075') },
            { lat: Number('39.468450'), lng: Number('-0.377011') },
            { lat: Number('39.468442'), lng: Number('-0.376905') },
            { lat: Number('39.468810'), lng: Number('-0.376859') },
            { lat: Number('39.469071'), lng: Number('-0.376831') },
            { lat: Number('39.469169'), lng: Number('-0.376658') },
            { lat: Number('39.469359'), lng: Number('-0.376649') },
            { lat: Number('39.469518'), lng: Number('-0.376830') },
        ],
        fin: { lat: Number('39.469710'), lng: Number('-0.376930') },
        imagen: "imagenes/imagenes-aventuras/Estacion_Norte.jpg",
        imagen2: "imagenes/imagenes-aventuras/ayuntamiento.jpg",
    ...
    // Parada 43: Puerta Gótica Lonja (Mercado de la Seda) (Párrafos: 394)
    {
        id: "Av34km-P-43",
        tipo: "parada",
        parada: 46, // mapa número 34
        mapa_numero: 34,
        nombre: "Lonja (Mercado de la Seda)",
        coordenadas: { lat: Number('39.474391'), lng: Number('-0.378047') },
        imagen: "imagenes/imagenes-aventuras/lonja7.jpg",
    },
    ...
    // Parada 51: Torre Barroca de Santa Catalina (Reto 40) (Párrafos: 421, 422)
    {
        id: "Av34km-P-51",
        tipo: "parada",
        parada: 54, // mapa número 38
        mapa_numero: 38,
        nombre: "Torre Barroca de Santa Catalina",
        coordenadas: { lat: Number('39.473830'), lng: Number('-0.375710') },
        imagen: "imagenes/imagenes-aventuras/torre_santa_catalina.jpg",
    ...
    // Parada 54 - Puerta de los Hierros (Barroca) de la Catedral de Valencia (Reto 43) (Párrafos: 429, 430, 432, 431)
    {
        id: "Av34km-P-54",
        tipo: "parada",
        parada: 57, // mapa número 39
        mapa_numero: 39,
        nombre: "Puerta de los Hierros (Barroca) de la Catedral de Valencia",
        coordenadas: { lat: Number('39.475210'), lng: Number('-0.375610') },
        imagen: "imagenes/imagenes-aventuras/puerta_barroca_catedral_miguelete.jpg",
    ...
    // Parada 61: Plaza Décimo Junio Bruto (Plaza de la Almoína) Modernismo, Casa del Punt de Gantxo (Reto 48) (Párrafos: 51, 454, 455, 455-B, 456)
    {
        id: "Av34km-P-61",
        tipo: "parada",
    ...
    // Parada 68: Plaza de la Virgen (Fallas y Basílica, Arco Novo Catedral, Puerta Gótica Catedral, reto fuente neptuno) (Reto 54) (Párrafos: 469, 470, 471, 472, 473, 474, 476, 355, 477, 478, 479, 478)
    {
        id: "Av34km-P-68",
        tipo: "parada",
        parada: 71, // mapa número 43
        mapa_numero: "43",
        nombre: "Plaza de la Virgen",
        coordenadas:  { lat: Number('39.476600'), lng: Number('-0.375290') },
        imagen: "imagenes/imagenes-aventuras/puerta_gotica_catedral_2.jpg",
    ...
    // Parada 69 - Palacio de la Generalitat Valenciana (Reto 55) (Párrafos: 481, 482, 482-B, 483)
    {
        id: "Av34km-P-69",
        tipo: "parada",
        parada: 72, // mapa número 44
        mapa_numero: "44",
        nombre: "Palacio de la Generalitat Valenciana",
        coordenadas: { lat: Number('39.476680'), lng: Number('-0.376710') },
        imagen: "imagenes/imagenes-aventuras/palau_de_la_generalitat.jpg",
    },
    // Tramo 44 - Palacio de la Generalitat Valenciana → Calle Caballeros (Párrafos: 484, 485, 486)
    {
        id: "Av34km-TR-44",
        tipo: "tramo",
    ...
    // Tramo 46 - Iglesia de San Nicolás FRONT → Iglesia de San Nicolás BACK (Párrafos: 491, 63)
    {
        id: "Av34km-TR-46",
        tipo: "tramo",
    ...
    // Parada 104: Na Turia (Plataforma elevada) (Reto 79) (Párrafos: 606, 231, 608, 609, 610)
    {
        id: "Av34km-P-104",
        tipo: "parada",
        parada: 107, // mapa número 68
        mapa_numero: 68,
        nombre: "Na Turia",
        coordenadas: { lat: Number('39.475770'), lng: Number('-0.397480') },
        imagen: "imagenes/imagenes-aventuras/naturia_plataforma.jpg",
    ...
    // Parada 119: Museo de Ciencias Naturales (Reto 85) (Párrafos: viv6, viv5)
    {
        id: "Av34km-P-119",
        tipo: "parada",
        parada: 122, // mapa número v8
        mapa_numero: "v8",
        nombre: "Museo de Ciencias Naturales",
        coordenadas: { lat: Number('39.479455'), lng: Number('-0.368610') },
        imagen: "imagenes/imagenes-aventuras/viveros_museo_ciencias_naturales.jpg",
    },
    // Tramo 83: Museo de Ciencias Naturales → Jardín de la Rosaleda (Párrafos: viv7, viv8)
    {
        id: "Av34km-TR-83",
        tipo: "tramo",
    ...
    // Parada 122: Estanque de los patos (Reto 86) (Párrafos: viv11-C, viv12)
    {
        id: "Av34km-P-122",
        tipo: "parada",
    ...
    // Parada 130: Iglesia Santo Tomás Apostol y San Felipe Neri (Párrafos: 669)
    {
        id: "Av34km-P-130",
        tipo: "parada",
        parada: 133, // mapa número 82
        mapa_numero: "82",
        nombre: "Iglesia Santo Tomás Apostol y San Felipe Neri",
        coordenadas:  { lat: Number('39.473833'), lng: Number('-0.372479') },
        imagen: "imagenes/imagenes-aventuras/iglesia_san_felipe_neri.jpg",
    },
    // Tramo 92: Iglesia Santo Tomás Apostol y San Felipe Neri → Iglesia San Juan del Hospital (Párrafos: 670)
    {
        id: "Av34km-TR-92",
        tipo: "tramo",
        tramo: 92, // De mapa número 82 a mapa número 83
        mapa_numero: "82→83",
        nombre: "Iglesia Santo Tomás Apostol y San Felipe Neri → Iglesia San Juan del Hospital",
        inicio: { lat: Number('39.473833'), lng: Number('-0.372479') },
        waypoints:
        [
            { lat: Number('39.473998'), lng: Number('-0.372704') }
    ...
    // Parada 131: Iglesia San Juan del Hospital (Párrafos: 671, 672)
    {
        id: "Av34km-P-131",
        tipo: "parada",
        parada: 134, // mapa número 83
        mapa_numero: "83",
        nombre: "Iglesia San Juan del Hospital",
        coordenadas:  { lat: Number('39.474454'), lng: Number('-0.372731') },
        imagen: "imagenes/imagenes-aventuras/iglesia_san_juan_del_hospital.jpg",
    },
    // Tramo 93: Iglesia San Juan del Hospital → Palacio Arzobispal (Párrafos: 453, 98)
    {
        id: "Av34km-TR-93",
        tipo: "tramo",
        tramo: 93, // De mapa número 83 a mapa número 84
        mapa_numero: "83→84",
        nombre: "Iglesia San Juan del Hospital → Palacio Arzobispal",
        inicio: { lat: Number('39.474454'), lng: Number('-0.372731') },
        waypoints:
    ...
    // Parada 132: Palacio Arzobispal (Párrafos: 673)
    {
        id: "Av34km-P-132",
        tipo: "parada",
        parada: 135, // mapa número 84
        mapa_numero: "84",
        nombre: "Palacio Arzobispal",
        coordenadas:  { lat: Number('39.475577'), lng: Number('-0.374196') },
        imagen: "imagenes/imagenes-aventuras/palacio_arzobispal.jpg",
    },
    // Tramo 94: Palacio Arzobispal → Museo de la Ciudad (Párrafos: 674)
    {
        id: "Av34km-TR-94",
        tipo: "tramo",
    ...
    // Parada 133: Museo de la Ciudad (Párrafos: 674-B)
    {
        id: "Av34km-P-133",
        tipo: "parada",
        parada: 136, // mapa número 85
        mapa_numero: "85",
        nombre: "Museo de la Ciudad",
        coordenadas:  { lat: Number('39.475889'), lng: Number('-0.374065') },
        imagen: "imagenes/imagenes-aventuras/museo_de_la_ciudad.jpg",
    },
    // Parada 134: Cripta de San Vicente Mártir (Párrafos: 675)
    {
        id: "Av34km-P-134",
        tipo: "parada",
        parada: 137, // mapa número 86
        mapa_numero: "86",
        nombre: "Cripta de San Vicente Mártir",
        coordenadas:  { lat: Number('39.475939'), lng: Number('-0.374076') },
        imagen: "imagenes/imagenes-aventuras/.jpg",
    },
    // Tramo 95: Cripta de San Vicente Mártir → Amudín (Párrafos: 676)
    {
        id: "Av34km-TR-95",
        tipo: "tramo",
        tramo: 95, // De mapa número 86 a mapa número 87
        mapa_numero: "86→87",
    ...
    // Parada 135: Almudín (Párrafos: 678, 677)
    {
        id: "Av34km-P-135",
        tipo: "parada",
        parada: 138, // mapa número 87
        mapa_numero: "87",
        nombre: "Almudín",
        coordenadas:  { lat: Number('39.475939'), lng: Number('-0.374076') },
        imagen: "imagenes/imagenes-aventuras/museo_de_la_ciudad.jpg",
    },
     // Tramo 96: Almudín → Iglesia de San Lorenzo y Cortes Valencianas (Párrafos: 679, 681)
    {
        id: "Av34km-TR-96",
        tipo: "tramo",
        tramo: 96, // De mapa número 87 a mapa número 88/89
        mapa_numero: "87→88/89",
        nombre: "Almudín → Iglesia de San Lorenzo y Cortes Valencianas",
        inicio: { lat: Number('39.475939'), lng: Number('-0.374076') },
        waypoints:
        [
    ...
    // Parada 136: Iglesia de San Lorenzo (Reto 89) (Párrafos:682, 462, 684, 683)
    {
        id: "Av34km-P-136",
        tipo: "parada",
        parada: 139, //  mapa número 88
        mapa_numero: "88",
        nombre: "Iglesia de San Lorenzo",
        coordenadas: { lat: Number('39.477820'), lng: Number('-0.374870') },
        imagen: "imagenes/imagenes-aventuras/iglesia_san_lorenzo.jpg",
    },
    // Parada 137: Palacio de los Borgia  (Párrafos: 685, 686)
    {
        id: "Av34km-P-137",
        tipo: "parada",
        parada: 140, //  mapa número 89
        mapa_numero: "89",
    ...
    // Tramo 97: Palacio de los Borgia → Torres de Serranos (Párrafos: 680)
    {
        id: "Av34km-TR-97",
        tipo: "tramo",
        tramo: 97, // De mapa número 89 a mapa número 1
        mapa_numero: "89→1",
    ...
    // Parada 138 - FINAL: Torres de Serranos Final (Reto90Puzzle PZ-05) (Párrafos: 475, 503, 507, 526)
    {
        id: "Av34km-P-138",
        tipo: "parada",
        parada: 141, // mapa número 1
        mapa_numero: 1,
        nombre: "Torres de Serranos Final",
        coordenadas: { lat: Number('39.478590'), lng: Number('-0.376330') },
        imagen: "imagenes/imagenes-aventuras/00_ torres_de serranos_back.jpg"
