...
| `DATOS.SOLICITAR_RETO` | `DATOS.RESPUESTA_RETO` | ✅ _hdl_DATOS_RESPUESTA_RETO | hijo4 | ✅ |
...
- MOSTRAR_MAPA_JPG → _hdl_NAVEGACION_MOSTRAR_MAPA_JPG
...
- PARADA_COMPLETADA → _hdl_NAVEGACION_PARADA_COMPLETADA
...
- RESPUESTA_RETO → _hdl_DATOS_RESPUESTA_RETO
