...
- Name: 01-fase1-boot.spec.js >> FASE 1 — Secuencia de arranque del padre >> globalThis.mensajeria expone enviarMensaje como función
- Location: tests\e2e\01-fase1-boot.spec.js:80:3
