...
- Name: 03-handler-registration.spec.js >> Registro de handlers — estado tras FASE 1 >> 1b. __CONTROLADOR_REGISTRADOS tiene entradas (algún handler fue registrado)
- Location: tests\e2e\03-handler-registration.spec.js:48:3
