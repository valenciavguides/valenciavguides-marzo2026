...
- Name: 06-race-conditions.spec.js >> Race conditions documentadas — DT-1 Opción B >> Race #4d. las funciones de Script 2 en app.js están disponibles vía window tras boot
- Location: tests\e2e\06-race-conditions.spec.js:245:3
