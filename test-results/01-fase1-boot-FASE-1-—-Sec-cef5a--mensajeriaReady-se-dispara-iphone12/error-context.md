...
- Name: 01-fase1-boot.spec.js >> FASE 1 — Secuencia de arranque del padre >> 1a. globalThis.mensajeria existe en el momento en que mensajeriaReady se dispara
- Location: tests\e2e\01-fase1-boot.spec.js:42:3
