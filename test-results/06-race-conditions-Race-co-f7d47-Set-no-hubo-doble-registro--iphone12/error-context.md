...
- Name: 06-race-conditions.spec.js >> Race conditions documentadas — DT-1 Opción B >> Race #3c. los handlers de modo CAMBIO_MODO_ENTENDIDO/EFECTUADO están en el Set (no hubo doble registro)
- Location: tests\e2e\06-race-conditions.spec.js:175:3
