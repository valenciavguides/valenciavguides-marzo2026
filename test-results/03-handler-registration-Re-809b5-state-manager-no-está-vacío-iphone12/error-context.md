...
- Name: 03-handler-registration.spec.js >> Registro de handlers — estado tras FASE 1 >> 1b. el mapa de controladores en state-manager no está vacío
- Location: tests\e2e\03-handler-registration.spec.js:79:3
