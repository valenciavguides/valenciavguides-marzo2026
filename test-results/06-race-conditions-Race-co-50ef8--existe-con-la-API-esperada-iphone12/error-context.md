...
- Name: 06-race-conditions.spec.js >> Race conditions documentadas — DT-1 Opción B >> Race #1a. globalThis.funcionesMapa existe con la API esperada
- Location: tests\e2e\06-race-conditions.spec.js:62:3
